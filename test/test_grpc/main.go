...
func (s *server1) SayHello(ctx context.Context, in *pb.HelloRequest) (*pb.HelloReply, error) {
...
func startServer2() {
	...
	// 注册Greeter服务
	pb.RegisterGreeterServer(s, &server2{c})
